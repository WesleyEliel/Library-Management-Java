            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center  mb-4">
                        <h4 class="card-title pt-2 pb-2 pl-5 text-">Mettre à jour l'
                            utilisateur ${ user.fullName }.</h4>
                    </div>
                    <div class="row justify-content-md-center">
                        <div class="col-12 col-md-8">
                            ...
                            <c:url var="save_user_url" value="/users/${user.id}/update-save"/>
                            ...
                            <form:form action="${save_user_url}" method="post" modelAttribute="user"
                                ...
                                <div class="d-flex justify-content-between pt-4">
                                    <a class="btn btn-outline-danger btn-fw" href="/users">Annuler</a>
